...
def generate_fractures(input_dir,num_modes=20,num_impacts=80,output_dir=None,verbose=True,compressed=True,cage_size=4000):
    ...
    t10 = time.time()
    v, f = gpytoolbox.lazy_cage(v_fine,f_fine,num_faces=cage_size,grid_size=256)
    t11 = time.time()
    cage_time = t11-t10
    if verbose:
